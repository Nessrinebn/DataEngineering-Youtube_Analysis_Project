...
## @type: DataSource
## @args: [database = "youtube-raw", table_name = "raw_statistics", transformation_ctx = "datasource0"]
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://de-on-youtube-raw-cleansed/youtube/raw-static/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
